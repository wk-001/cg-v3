...
class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
    ...
    @Autowired
    private com.wk.oauth.config.CustomUserAuthenticationConverter customUserAuthenticationConverter;
    ...
    public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
        //从数据库表oauth_client_details中查询对应的客户端数据
     ...
     */
    @Bean
    public JwtAccessTokenConverter jwtAccessTokenConverter(com.wk.oauth.config.CustomUserAuthenticationConverter customUserAuthenticationConverter) {
